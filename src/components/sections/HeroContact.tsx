  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 md:content-padding py-4 sm:py-6 md:py-8 lg:py-6 text-center flex flex-col items-center justify-center">
        ...
        {/* Main Heading */}
        <h1 className="w-full sm:w-[85%] md:w-[75%] lg:w-[75%] xl:w-[70%] font-['DM_Sans'] font-black text-[#98012E] text-center leading-tight tracking-normal mx-auto px-4 text-[30px] xs:text-[34px] sm:text-[40px] md:text-[52px] lg:text-[68px] xl:text-[86px]">
