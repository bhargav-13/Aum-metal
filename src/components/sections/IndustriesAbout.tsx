...
export const IndustriesAbout = () => {
  ...
  return (
    <section className="relative min-h-0 lg:min-h-screen w-full flex items-center justify-center pt-6 sm:pt-8 md:pt-10 lg:pt-12 pb-6 sm:pb-8 md:pb-10 lg:pb-12 overflow-hidden">
