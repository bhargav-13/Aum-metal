...
export const IndustryHome = () => {
  ...
  return (
    <section
      id="industry-home"
      className="relative min-h-0 lg:min-h-screen w-full flex items-center justify-center pt-12 sm:pt-16 md:pt-20 lg:pt-24 pb-6 sm:pb-8 md:pb-10 lg:pb-12 overflow-hidden bg-white"
    >
      {/* Background Image */}
